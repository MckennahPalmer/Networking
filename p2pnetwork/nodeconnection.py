...
class NodeConnection(threading.Thread):
    """The class NodeConnection is used by the class Node and represent the socket connection with another node.
       
       Instantiates a new NodeConnection. Do not forget to start the thread. All communication is handled by this
       connection.
        main_node: The Node class that received a connection.
        sock: The socket that is associated with the client connection.
        id: The id of the connected node (at the other side of the connection).
    ...
    def __init__(self, main_node, sock, id, host, port):
        ...
        All communication is handled by this connection.
            main_node: The Node class that received a connection.
            sock: The socket that is associated with the client connection.
            id: The id of the connected node (at the other side of the connection).
            host: The host/ip of the main node.
    ...
    def send(self, data, encoding_type='utf-8', compression='none'):
        ...
        When the socket is corrupted the node connection is closed.
           """
